...
The canonical V4 research dossier. Externally checkable claims carry epistemic labels and sources; open verification items (unconfirmed citations, pre-registration, statistical calibration) are marked inline. Verification reports marked SUPERSEDED are historical. V3 24-month capital figures retained in `08_CAPITAL_PLAN.md` §§1–§5 are historical context; the V4 36-month rebasing is explicitly unresolved (§9).
...
| **[`06_CORE_RESEARCH_PROGRAM.md`](./submission/06_CORE_RESEARCH_PROGRAM.md)** | Core Research Program | Twelve RQs (RQ1–RQ12) across 3 arcs, G1–G8 goals, discrete survival hazard modeling for $\text{MDDD}_\tau$, pre-registration commitment. |
...
| **[`08_CAPITAL_PLAN.md`](./submission/08_CAPITAL_PLAN.md)** | Capital & Expense Plan | V3 $400,000 history preserved; V4 36-month rebasing explicitly unresolved (no new ask). |
...
| **[`RESEARCH_DECISION_LEDGER.md`](./submission/RESEARCH_DECISION_LEDGER.md)** | Living Systems ADR Ledger | Architecture Decision Records covering initial formulation (AD-001–AD-011), post-diligence decisions (AD-012–AD-023; AD-017/AD-019 superseded), and V4 transition (AD-024–AD-034). |
| **[`DOSSIER_CHANGELOG.md`](./submission/DOSSIER_CHANGELOG.md)** | Master Provenance Ledger | Full traceability V1 → V2 → V3 → V4 (CHG-001–CHG-047). |
