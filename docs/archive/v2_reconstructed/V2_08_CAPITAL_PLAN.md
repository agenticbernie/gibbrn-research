# 08 — Capital Allocation, Financial Engineering, and Sensitivity Plan (V2)
...
The compute model recalculates token spend across 13,200 trajectories consuming 10.63B tokens at an average blended rate of \$4.50 per 1M tokens:
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Phase 1: Interceptor Calibration (M3)** | Tier 2 (Coding: Claude Sonnet) | 500 | 12 | 180M tokens | \$5.00 | \$900 |
